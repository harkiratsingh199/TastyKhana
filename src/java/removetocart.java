...
public class removetocart extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        for (int i = 0; i < alCart.size(); i++)
        {
            ...
            out.println("<label style=\"margin-left: 30px\"><strike>$" + alCart.get(i).mitemdisplayprice + "/-</strike></label><br>");
            out.println("<label style=\"margin-left: 30px\">Offer Price - $ " + alCart.get(i).mitemofferprice + "/-</label>");
        ...
        out.println("</div>");
        out.println("<div class=\"row\">");
        out.println("<label style=\"margin-left: 30px\">Total Price: $ " + totalPrice + "/-</label><br>");
