                ...
                <%
                    try
                    {
                        ...
                        while (rs.next())
                        {
                            ...
                            String couponMinPrice = "Minimum Applicable on $ " + rs.getString("min_price");
                %>
        ...
        <div class="container">
            ...
            <div class="col-sm-9 well" style="border-radius: 10px">
                ...
                <div id="div_<%= div_id%>" style="margin-top: 10px" class="col-sm-12">
                    ...
                    <div class="col-sm-4" style="height: 75px; padding: 15px">
                        <label id="dp"><strike>$ <%=mitemdisplayprice%></strike></label><br>
                        <label id="of">Offer Price : $ <%=mitemofferprice%></label>
                    </div>
                    <div class="col-sm-4" style="height: 75px; padding: 15px">
                        <%
